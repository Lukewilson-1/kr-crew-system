...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/admin/meta/{collection}/{id}', [AdminMetaController::class, 'save'])->middleware('throttle:120,1');
    Route::delete('/admin/meta/{collection}/{id}', [AdminMetaController::class, 'delete'])->middleware('throttle:120,1');
    Route::get('/mysql/meta/{collection}', [AdminMetaController::class, 'normalizedIndex']);
    Route::post('/mysql/meta/{collection}/{id}', [AdminMetaController::class, 'normalizedSave'])->middleware('throttle:120,1');
    Route::delete('/mysql/meta/{collection}/{id}', [AdminMetaController::class, 'normalizedDelete'])->middleware('throttle:120,1');
    Route::get('/mysql/users', [AdminMetaController::class, 'usersIndex']);
    Route::post('/mysql/users/{id}', [AdminMetaController::class, 'usersSave'])->middleware('throttle:120,1');
    Route::delete('/mysql/users/{id}', [AdminMetaController::class, 'usersDelete'])->middleware('throttle:120,1');
    ...
    Route::post('/mysql/crew-view/{recordId}', [CrewDataController::class, 'normalizedSave'])->middleware('throttle:120,1');
    Route::delete('/mysql/crew-view/{recordId}', [CrewDataController::class, 'normalizedDelete'])->middleware('throttle:120,1');
    ...
    Route::post('/running-rooms/api/matters', [RunningRoomController::class, 'storeMatter'])->middleware('throttle:120,1');
    Route::put('/running-rooms/api/matters/{id}', [RunningRoomController::class, 'updateMatter'])->middleware('throttle:120,1');
    Route::delete('/running-rooms/api/matters/{id}', [RunningRoomController::class, 'deleteMatter'])->middleware('throttle:120,1');
    Route::post('/running-rooms/api/settings/beds', [RunningRoomController::class, 'updateBeds'])->middleware('throttle:120,1');
    Route::post('/running-rooms/api/settings/options', [RunningRoomController::class, 'updateOptions'])->middleware('throttle:120,1');
    Route::get('/running-rooms/api/notifications', [RunningRoomController::class, 'notifications']);
    Route::post('/running-rooms/api/notifications/read', [RunningRoomController::class, 'markNotificationsRead'])->middleware('throttle:120,1');
});

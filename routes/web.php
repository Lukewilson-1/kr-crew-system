...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/admin/meta/{collection}/{id}', [AdminMetaController::class, 'save'])->middleware('ensure.can.write')->middleware('throttle:120,1');
    Route::delete('/admin/meta/{collection}/{id}', [AdminMetaController::class, 'delete'])->middleware('ensure.can.write')->middleware('throttle:120,1');
    Route::get('/mysql/meta/{collection}', [AdminMetaController::class, 'normalizedIndex']);
    Route::post('/mysql/meta/{collection}/{id}', [AdminMetaController::class, 'normalizedSave'])->middleware('ensure.can.write')->middleware('throttle:120,1');
    Route::delete('/mysql/meta/{collection}/{id}', [AdminMetaController::class, 'normalizedDelete'])->middleware('ensure.can.write')->middleware('throttle:120,1');
    Route::get('/mysql/users', [AdminMetaController::class, 'usersIndex']);
    Route::post('/mysql/users/{id}', [AdminMetaController::class, 'usersSave'])->middleware('ensure.can.write')->middleware('throttle:120,1');
    Route::delete('/mysql/users/{id}', [AdminMetaController::class, 'usersDelete'])->middleware('ensure.can.write')->middleware('throttle:120,1');
    ...
    Route::post('/mysql/crew-view/{recordId}', [CrewDataController::class, 'normalizedSave'])->middleware('ensure.can.write')->middleware('throttle:120,1');
    Route::delete('/mysql/crew-view/{recordId}', [CrewDataController::class, 'normalizedDelete'])->middleware('ensure.can.write')->middleware('throttle:120,1');
    ...
    Route::post('/running-rooms/api/records', [RunningRoomController::class, 'storeRecord'])->middleware('ensure.can.write')->middleware('throttle:120,1');
    Route::post('/running-rooms/api/records/{id}/checkout', [RunningRoomController::class, 'checkoutRecord'])->middleware('ensure.can.write')->middleware('throttle:120,1');
    Route::delete('/running-rooms/api/records/{id}', [RunningRoomController::class, 'deleteRecord'])->middleware('ensure.can.write')->middleware('throttle:120,1');
    Route::post('/running-rooms/api/matters', [RunningRoomController::class, 'storeMatter'])->middleware('ensure.can.write')->middleware('throttle:120,1');
    Route::put('/running-rooms/api/matters/{id}', [RunningRoomController::class, 'updateMatter'])->middleware('ensure.can.write')->middleware('throttle:120,1');
    Route::delete('/running-rooms/api/matters/{id}', [RunningRoomController::class, 'deleteMatter'])->middleware('ensure.can.write')->middleware('throttle:120,1');
    Route::post('/running-rooms/api/settings/beds', [RunningRoomController::class, 'updateBeds'])->middleware('ensure.can.write')->middleware('throttle:120,1');
    Route::post('/running-rooms/api/settings/options', [RunningRoomController::class, 'updateOptions'])->middleware('ensure.can.write')->middleware('throttle:120,1');
    Route::get('/running-rooms/api/notifications', [RunningRoomController::class, 'notifications']);
    Route::post('/running-rooms/api/notifications/read', [RunningRoomController::class, 'markNotificationsRead'])->middleware('ensure.can.write')->middleware('throttle:120,1');
});
